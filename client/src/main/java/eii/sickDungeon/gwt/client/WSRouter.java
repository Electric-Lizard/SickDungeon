...
import eii.sickDungeon.gwt.client.properties.Config;
import eii.sickDungeon.gwt.client.sync.DataFetchHandler;
import eii.sickDungeon.gwt.client.sync.RequestParser;
...
public class WSRouter implements Router {
    private EndPoint endPoint = new EndPoint(this);
    ...
    public static class EndPoint implements WebSocketListener {
        ...
        protected EndPoint(WSRouter router) {
            this.router = router;
        }
