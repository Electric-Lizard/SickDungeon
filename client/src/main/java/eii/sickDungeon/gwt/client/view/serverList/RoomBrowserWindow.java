package eii.sickDungeon.gwt.client.view.serverList;
...
import eii.sickDungeon.gwt.client.assets.Assets;
import eii.sickDungeon.gwt.shared.model.Room;
...
public class RoomBrowserWindow extends DialogBox {
    ...
    public RoomBrowserWindow() {
        ...
        Assets.INSTANCE.serverListCss().ensureInjected();
        addStyleName(Assets.INSTANCE.serverListCss().dialog());
    ...
    public void resetRoomList(RoomCollection roomCollection) {
        ...
        populateRoomList(roomCollection);
        super.center();
    }
